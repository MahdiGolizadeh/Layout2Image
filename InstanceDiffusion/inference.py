...
if __name__ == "__main__":  
    ...
    parser.add_argument("--load_ckpt_to_device", action="store_true", help="Load checkpoint tensors directly onto the selected device to reduce peak CPU RAM usage on memory-limited hosts such as Colab.")
